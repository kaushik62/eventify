export function Footer() {
  return (
    <footer className="border-t border-border/70 bg-card/55 backdrop-blur-sm">
      <div className="mx-auto flex max-w-[88rem] flex-col gap-8 px-4 py-12 sm:px-6 lg:px-8 md:flex-row md:items-center md:justify-between">
        <div>
